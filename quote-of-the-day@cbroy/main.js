...
QotDDesklet.prototype = {
  ...
  _initSettings: function() {
      try{
        this.settings = new Settings.DeskletSettings(this, UUID,
          this._instanceId);

        this.settings.bindProperty(Settings.BindingDirection.IN,
          'update-time', '_delay', this._update_loop, null);
        this.settings.bindProperty(Settings.BindingDirection.IN,
          'service', 'service', this._initDriver, null);

        this.settings.bindProperty(Settings.BindingDirection.IN,
          'font-size', 'font_size', this._updateStlye, null);
        this.settings.bindProperty(Settings.BindingDirection.IN,
          'font-family', 'font_family', this._updateStlye, null);
        this.settings.bindProperty(Settings.BindingDirection.IN,
          'font-color', 'font_color', this._updateStlye, null);
      }catch(e) {
  ...
  _updateStlye: function() {
    let tempStyle = 'font-size:' + this.font_size+'px;';
  ...
  _initDriver: function() {
    ...
    switch(this.service) {
      case 'forismatic':
        this.driver = new Drivers.DriverForismatic();
        break;
      case 'quotesondesign':
        this.driver = new Drivers.DriverQOnDesigns();
        break;
      case 'icndb':
        this.driver = new Drivers.DriverChuckNorris();
        break;
      case 'stormconsultancy':
        this.driver = new Drivers.DriverStormConsul();
        break;
      default:
        this.driver = new Drivers.DriverForismatic();
    }
  ...
  _update_loop: function() {
    ...
    this._update();
    this.update_id = Mainloop.timeout_add_seconds(60 * this._delay,
